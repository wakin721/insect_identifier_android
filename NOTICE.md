...
The bundled `models/best.pt` checkpoint was supplied for this project. Confirm ownership, dataset rights, and distribution rights before publishing the checkpoint or derivative Android application.
